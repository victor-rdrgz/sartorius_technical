...
@patch('builtins.input', side_effect=['1', 'Test Product', 'Test Description', '20.0', '0'])
...
def test_operation_insert_product(mock_create, mock_input):
    ...
    Mock user input to simulate inserting a product and verify that create_product is called.
    """
    operation()
...
@patch('builtins.input', side_effect=['3', '1', 'Updated Product', 'Updated Description', '25.0', '0'])
...
def test_operation_update_product(mock_update, mock_input):
    ...
    Mock user input to simulate updating a product and verify that update_product is called.
    """
    operation()
...
def test_operation_delete_product(mock_delete, mock_input):
    ...
    Mock user input to simulate deleting a product and verify that delete_product is called.
    """
    operation()
